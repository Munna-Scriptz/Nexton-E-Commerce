        ...
        <div className='w-[600px] h-[500px] bg-[#f2f2f2] overflow-hidden relative z-[999] p-5 rounded-[7px] shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]'>
            ...
            <div className='flex justify-between'>
                <div>
                    ...
                    <Link onClick={HideByLink} className='LoginWithButton2 text-white py-[6px] px-[24px] lg:py-[6px] lg:px-[36px] border-[2px] rounded-full flex items-center w-fit gap-2.5 duration-[.3s] hover:scale-[1.06] cursor-pointer' to={'/Register'}>Sign Up</Link>
                </div>
                ...
                <div className='flex items-end flex-col'>
                    ...
                    <Link onClick={HideByLink} className='LoginWithButton text-second py-[6px] px-[24px] lg:py-[6px] lg:px-[36px] border-[2px] rounded-full flex items-center w-fit gap-2.5 duration-[.3s] hover:scale-[1.06] cursor-pointer' to={'/Login'}>login</Link>
                    {/* --------Or Start------- */}
