    ...
    <>
        <section id='Add-To-Cart' className='h-full bg-[#f8f8f8] w-[550px] p-5 border-l-2 z-10'>
            ...
            <div className='lg:mt-7 mt-0'>
                ...
                <div>
                    <Link to={'/Checkout'} className='inline-block py-2 w-full bg-second text-white text-center rounded-[10px] duration-[.3s] hover:scale-[1.05] hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>Buy items</Link>
                </div>
            </div>
        </section>
