...
const BottomBanner = () => {
  return (
    <section className='w-full h-[437px] mt-[120px] mb-[52px] hidden lg:block bg-no-repeat bg-center bg-cover' style={{background: `url(${BannerImage})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover',}}>
      <div className="container">
                <div id="Banner_Text" className='lg:py-[148px] py-[94px] pl-[24px] lg:pl-0 lg:ml-[120px]'>
