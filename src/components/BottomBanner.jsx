...
const BottomBanner = () => {
  return (
    <section className='w-full h-[437px] mt-[88px] pb-[52px]' style={{background: `url(${BannerImage})` ,}}>
      <div className="container">
                <div id="Banner_Text" className='lg:py-[148px] py[94px] pl-[24px] lg:pl-0 ml-[120px]'>
