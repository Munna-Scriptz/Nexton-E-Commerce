  ...
  return (
    <>
      <section id='Checkout-Summery' className='w-[618px]'>
          ...
          {/* -------Checkout final--------- */}
          <div className='mt-6'>
            <p className='text-base text-Primary font-normal flex items-center justify-between'>Subtotal <span>$169.99</span></p>
            ...
            <h2 className='text-second font-semibold text-base flex items-center justify-between mt-6'>Order total <span>$199.89</span></h2>
